...
urlpatterns = [
    ...
    path('reset-password/<str:uidb64>/<str:token>/', views.reset, name='password_reset_confirm'),
    path('change-password/<str:uidb64>/<str:token>/', views.change, name='password_change_confirm'),
